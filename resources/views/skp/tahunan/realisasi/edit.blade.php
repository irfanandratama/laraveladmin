...
@section('title', '| Edit Realisasi SKP Tahunan')
               ...
               <div class="offset-md-3 col-lg-6">
                  ...
                  <div class="card">
                      <div class="card-header">
                          <strong class="card-title"> <h1><i class='fa fa-user-plus'></i> Edit Realisasi SKP Tahunan </h1></strong>
                      </div>
                      <div class="card-body">  
                        @if ($errors->any())
                        ...
                        {{ Form::model($skpline, array('route' => array('realisasi.update', $skpline->id), 'method' => 'PUT')) }}
                        ...
                        {{ Form::submit('Edit Realisasi', array('class' => 'btn btn-primary')) }}
